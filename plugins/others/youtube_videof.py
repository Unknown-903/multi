...
@Client.on_callback_query(filters.regex("^vytvideo"))
async def youtube_video_(bot, update):
    ...
    if update.from_user.id not in Config.AUTH_USERS:
        if Config.ONLY_URL_UPLOADER.upper() != "YES":
            await update.message.reply(
                "⚠️ Currently URL uploader function is Removed from this bot. You can use these bots 👇\n\n@urluploader2_cbot\n@VideoYoutubeDL2Bot (Upto 2GB)\n@UploaderURLNewBot",
    ...
    if t_response:
        ...
        if "formats" in response_json:
            ...
            if duration is not None:
                ...
                cb_string_128 = "vniceytdl/{}/{}/{}".format("audio", "128k", "mp3")
                "vniceytdl/{}/{}/{}".format("audio", "192k", "mp3")
                cb_string = "vniceytdl/{}/{}/{}".format("audio", "320k", "mp3")
                ...
                inline_keyboard.append(
                    [
                        ...
                        InlineKeyboardButton(
                            "🎵 MP3 " + "320k", callback_data=cb_string.encode("UTF-8")
                        ),
                    ]
                )
        else:
