...
@Client.on_callback_query(filters.regex("^acaudio3"))
async def ac3_audio(c, m):
    ...
    output_directory = f"{Config.DOWNLOAD_PATH}/{new_file_name}.ac3"
    commands = [
        "ffmpeg",
        "-i",
        input,
    ...
    try:
        ...
        captions = "File Name : " + new_file_name + ".ac3"

    ft = "Audio Converted to AC3 ✅ "
