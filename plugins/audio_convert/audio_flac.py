...
@Client.on_callback_query(filters.regex("^flac_audio"))
async def flac_audio(c, m):
    ...
    output_directory = f"{Config.DOWNLOAD_PATH}/{new_file_name}.flac"
    commands = [
        "ffmpeg",
        "-i",
        input,
    ...
    try:
        ...
        captions = "File Name : " + new_file_name + ".flac"

    ft = "Audio Converted to FLAC ✅ "
    premium_upload = CH.U4GB_AudioFLAC
