...
@Client.on_callback_query(filters.regex("^opus_audio"))
async def opusaudio(c, m):
    ...
    output_directory = f"{Config.DOWNLOAD_PATH}/{new_file_name}.opus"
    commands = [
        "ffmpeg",
        "-i",
        input,
    ...
    try:
        ...
        captions = "File Name : " + new_file_name + ".opus"

    ft = "Audio Converted to OPUS ✅ "
