...
@Client.on_callback_query(filters.regex("^wmaaud"))
async def wma_audio(c, m):
    ...
    output_directory = f"{Config.DOWNLOAD_PATH}/{new_file_name}.wma"
    commands = [
        "ffmpeg",
        "-i",
        input,
    ...
    try:
        ...
        captions = "File Name : " + new_file_name + ".wma"

    ft = "Audio Converted to WMA ✅ "
