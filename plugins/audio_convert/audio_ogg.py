...
@Client.on_callback_query(filters.regex("^ogg_audio"))
async def oggaudio(c, m):
    ...
    output_directory = f"{Config.DOWNLOAD_PATH}/{new_file_name}.ogg"
    commands = [
        "ffmpeg",
        "-i",
        input,
    ...
    try:
        ...
        captions = "File Name : " + new_file_name + ".ogg"

    ft = "Audio Converted to OGG ✅ "
